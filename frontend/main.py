...
class MainPHWindow(object):
    ...
    def tab_device_ui_elements(self):
        ...
        self.group_box_device = QtWidgets.QGroupBox(self.tab_device)
        self.group_box_device.setGeometry(QtCore.QRect(20, 30, 711, 321))
        self.group_box_device.setObjectName("group_box_device")
        self.line_edit_nombre_dispositivo_value = QtWidgets.QLineEdit(self.group_box_device)
        self.line_edit_nombre_dispositivo_value.setGeometry(QtCore.QRect(220, 30, 241, 31))
        self.line_edit_nombre_dispositivo_value.setStyleSheet("D{\n"
                                                                "background: rgb(255, 0, 255)\n"
                                                                "}")
        self.line_edit_nombre_dispositivo_value.setObjectName("line_edit_nombre_dispositivo_value")
        self.label_nombre_dispositivo = QtWidgets.QLabel(self.group_box_device)
        self.label_nombre_dispositivo.setGeometry(QtCore.QRect(10, 30, 181, 20))
        self.label_nombre_dispositivo.setObjectName("label_nombre_dispositivo")
        self.label_area_comun = QtWidgets.QLabel(self.group_box_device)
        self.label_area_comun.setGeometry(QtCore.QRect(10, 80, 181, 20))
        self.label_area_comun.setObjectName("label_area_comun")
        self.combo_box_area_comun = QtWidgets.QComboBox(self.group_box_device)
        self.combo_box_area_comun.setEnabled(True)
        self.combo_box_area_comun.setGeometry(QtCore.QRect(220, 70, 241, 31))
        self.combo_box_area_comun.setObjectName("combo_box_area_comun")
        self.combo_box_area_comun.addItem("")
        self.push_button_registrar_dispositivo = QtWidgets.QPushButton(self.group_box_device)
        self.push_button_registrar_dispositivo.setGeometry(QtCore.QRect(220, 270, 241, 31))
        self.push_button_registrar_dispositivo.setObjectName("push_button_registrar_dispositivo")
        self.label_mac = QtWidgets.QLabel(self.group_box_device)
        self.label_mac.setGeometry(QtCore.QRect(10, 130, 181, 20))
        self.label_mac.setObjectName("label_mac")
        self.label_mac_value = QtWidgets.QLabel(self.group_box_device)
        self.label_mac_value.setGeometry(QtCore.QRect(220, 130, 241, 20))
        self.label_mac_value.setObjectName("label_mac_value")
        self.label_estado_dispositivo = QtWidgets.QLabel(self.group_box_device)
        self.label_estado_dispositivo.setGeometry(QtCore.QRect(10, 180, 181, 20))
        self.label_estado_dispositivo.setObjectName("label_estado_dispositivo")
        self.label_estado_dispositivo_value = QtWidgets.QLabel(self.group_box_device)
        self.label_estado_dispositivo_value.setGeometry(QtCore.QRect(220, 180, 241, 20))
        self.label_estado_dispositivo_value.setObjectName("label_estado_dispositivo_value")
    ...
    def retranslate_ui_device(self):
        ...
        self.group_box_device.setTitle(_translate("Dialog", "Info del dispositivo"))
        ...
        self.combo_box_area_comun.setItemText(0, _translate("Dialog", "Seleccionar"))
        self.push_button_registrar_dispositivo.setText(_translate("Dialog", "Registrar dispositivo salida"))
        self.label_mac.setText(_translate("Dialog", "MAC ( ID unico)"))
        self.label_mac_value.setText(_translate("Dialog", "MAC ( ID UNICO)"))
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_device), _translate("Dialog", "Tab 1"))
    ...
    def tab_biometric_ui_elements(self):
        ...
        self.group_box_information = QtWidgets.QGroupBox(self.tab_fingerprint)
        self.group_box_information.setGeometry(QtCore.QRect(40, 20, 621, 171))
        ...
        self.combo_box_identification_type = QtWidgets.QComboBox(self.group_box_information)
        self.combo_box_identification_type.setGeometry(QtCore.QRect(290, 30, 271, 31))
        self.combo_box_identification_type.setObjectName("combo_box_identification_type")
        self.combo_box_identification_type.addItem("")
        self.combo_box_identification_type.addItem("")
        self.combo_box_identification_type.addItem("")
        self.label_identification_type = QtWidgets.QLabel(self.group_box_information)
        self.label_identification_type.setGeometry(QtCore.QRect(20, 40, 241, 21))
        self.label_identification_type.setObjectName("label_identification_type")
        self.label_identification_value = QtWidgets.QLabel(self.group_box_information)
        self.label_identification_value.setGeometry(QtCore.QRect(20, 80, 241, 31))
        self.label_identification_value.setObjectName("label_identification_value")
        self.line_edit_identification = QtWidgets.QLineEdit(self.group_box_information)
        self.line_edit_identification.setGeometry(QtCore.QRect(290, 80, 271, 31))
        self.line_edit_identification.setObjectName("line_edit_identification")
        self.push_button_search = QtWidgets.QPushButton(self.group_box_information)
        self.push_button_search.setGeometry(QtCore.QRect(290, 120, 271, 31))
        self.push_button_search.setStyleSheet("\n"
"border-radius: 10px;\n"
"")
        self.push_button_search.setObjectName("push_button_search")
        self.group_box_people = QtWidgets.QGroupBox(self.tab_fingerprint)
        self.group_box_people.setGeometry(QtCore.QRect(40, 200, 621, 261))
...
"")
        ...
        self.checkBoxDesactivarPersona = QtWidgets.QCheckBox(self.group_box_people)
        self.checkBoxDesactivarPersona.setGeometry(QtCore.QRect(290, 160, 51, 20))
        self.checkBoxDesactivarPersona.setObjectName("checkBoxDesactivarPersona")
        self.label_actualizarHuella = QtWidgets.QLabel(self.group_box_people)
        self.label_actualizarHuella.setGeometry(QtCore.QRect(20, 40, 241, 31))
        self.label_actualizarHuella.setObjectName("label_actualizarHuella")
        self.push_button_fingerprint = QtWidgets.QPushButton(self.group_box_people)
        self.push_button_fingerprint.setGeometry(QtCore.QRect(290, 40, 271, 31))
        self.push_button_fingerprint.setStyleSheet("\n"
"border-radius: 10px;\n"
"")
        self.push_button_fingerprint.setObjectName("push_button_fingerprint")
        self.label_name = QtWidgets.QLabel(self.group_box_people)
        self.label_name.setGeometry(QtCore.QRect(20, 100, 241, 31))
    ...
    def retranslate_ui_fingerprint(self):
        ...
        self.group_box_information.setTitle(_translate("Dialog", "Información"))
        self.combo_box_identification_type.setItemText(0, _translate("Dialog", "CC"))
        self.combo_box_identification_type.setItemText(1, _translate("Dialog", "DNI"))
        self.combo_box_identification_type.setItemText(2, _translate("Dialog", "TI"))
        self.label_identification_type.setText(_translate("Dialog", "Tipo de identicacion"))
