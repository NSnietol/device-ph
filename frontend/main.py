...
class MainPHWindow(object):
    ...
    def tab_device_ui_elements(self):
        ...
        self.group_box_inside_dispositivo = QtWidgets.QGroupBox(self.tab_fingerprint)
        self.group_box_inside_dispositivo.setGeometry(QtCore.QRect(50, 50, 711, 401))
        self.group_box_inside_dispositivo.setObjectName("group_box_inside_dispositivo")
        self.line_edit_nombre_dispositivo_value = QtWidgets.QLineEdit(self.group_box_inside_dispositivo)
...
"}")
        ...
        self.label_nombre_dispositivo = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        ...
        self.label_device_type = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        self.label_device_type.setGeometry(QtCore.QRect(10, 80, 181, 20))
        self.label_device_type.setObjectName("label_device_type")
        self.combo_box_device_type = QtWidgets.QComboBox(self.group_box_inside_dispositivo)
        ...
        self.push_button_registrar_dispositivo = QtWidgets.QPushButton(self.group_box_inside_dispositivo)
        self.push_button_registrar_dispositivo.setGeometry(QtCore.QRect(220, 300, 241, 31))
        ...
        self.label_mac_value = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        ...
        self.label_estado_dispositivo = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        self.label_estado_dispositivo.setGeometry(QtCore.QRect(10, 220, 181, 20))
        self.label_estado_dispositivo.setObjectName("label_estado_dispositivo")
        self.label_estado_dispositivo_value = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        self.label_estado_dispositivo_value.setGeometry(QtCore.QRect(220, 220, 241, 20))
        self.label_estado_dispositivo_value.setObjectName("label_estado_dispositivo_value")
        self.label_area_comun = QtWidgets.QLabel(self.group_box_inside_dispositivo)
        self.label_area_comun.setGeometry(QtCore.QRect(10, 130, 181, 20))
        self.label_area_comun.setObjectName("label_area_comun")
        self.combo_box_area_comun = QtWidgets.QComboBox(self.group_box_inside_dispositivo)
    ...
    def retranslate_ui_device(self):
        _translate = QtCore.QCoreApplication.translate
        self.group_box_inside_dispositivo.setTitle(_translate("Dialog", "Info del dispositivo"))
